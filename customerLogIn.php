<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM customer WHERE custID = '$custID' AND custPassword = '$custPassword'";
...
<body>
    ...
    <section class="login-clean" style="background: rgb(255,255,255);height: 710px;">
        <form method="POST" style="background: rgb(255, 255, 255);">
            ...
            <div class="illustration"><i class="icon ion-android-person" style="color: rgb(86,198,198);"></i></div>
            <div class="mb-3"><input class="form-control" type="text" placeholder="Customer ID" name="custID" required></div>
            <div class="mb-3"><input class="form-control" type="password" name="custPassword" placeholder="Password" required></div>
            <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit" value = "submit" name = "submit" style="background: rgb(86,198,198);">Log In</button></div><a class="forgot" href="customerSignUp.php">Create new account here.</a>
        </form>
    </section>
